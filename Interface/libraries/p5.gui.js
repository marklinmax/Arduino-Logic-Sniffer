// Modified version of the original p5.gui.js library to fits my needs.
...
(function() {
  ...
  function QSGui(label, parent, sketch) {
    ...
    this.setDraggable = function(val){ qs.setDraggable(val); };
    this.addButton = function(title, callback){ qs.addButton(title, callback); };
